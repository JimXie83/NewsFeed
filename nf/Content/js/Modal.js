...
// different than any other Controller in your entire AngularJS application.
// It takes services, manages the view-model, and knows NOTHING about the DOM.
app.controller("ConfirmModalController",function( $scope, modals ) {
...
app.service(
    ...
    function( $rootScope, $q ) {
        ...
        function params() {return( modal.params || {} );}
...
app.directive(
    ...
    function( $rootScope, modals ) {
        ...
        function link( scope, element, attributes ) {
            ...
            $rootScope.$on("modals.open", function handleModalOpenEvent( event, modalType ) { scope.subview = modalType; });
            // Listen for "close" events emitted by the modals service object.
            $rootScope.$on("modals.close", function handleModalCloseEvent( event ) { scope.subview = null; });
        }
    }
);